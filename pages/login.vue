        ...
        <div class="col-md-6 col-xl-5">
          ...
          <div class="login__box">
              ...
              <div class="col-12 mb-3">
                <div class="form-floating mb-3">
                  ...
                  <div class="password"><i class="bi " :class="showPassword ? 'bi-eye' : 'bi-eye-slash'"
                      @click="showPassword = !showPassword"></i></div>
            ...
            <form v-if="!isShowLogin" @submit.prevent="handleResetPassword">
              ...
              <div class="col-12 mb-3 mt-5">
                <div class="form-floating mb-3">
                  <input type="email" class="form-control border-0 border-bottom rounded-0" v-model="reset_email"
...
const toCheckout = computed(() => route.query.red === 'checkout');
  ...
  if (route.query.reg == 'success') {
    ...
    setTimeout(() => {
      if(toCheckout.value){
        ...
        router.replace({ path: '/login' , query: { red: 'checkout' } }); // Removes the query param
      }else{
