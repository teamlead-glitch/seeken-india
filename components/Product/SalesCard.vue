     ...
     <div class="col-md-6 col-lg-4  col-xl-4 col-xxl-3 mb-3">
                                        <a >
                                            <div class="product__box">
                                              <ProductCardFlashSaleTag :is_flashsale="product.is_flashsale? product.is_flashsale : product.is_flash_sale" :item_left="product?.stock" :endTime="product.to_date"/>
                                            ...
                                            <div class="bottom__box">
                                                ...
                                                <div class="btn_box"> <a  @click="handleAddToCart(product?.product_id, 1, product.variant_id?product.variant_id:0,'add',true)" class="btn_2">Buy Now</a></div>
                                           </div>
                                         </div></a>
                                    </div>
</template>
